  ...
  return (
    <div>
      ...
      {session ? (
        ...
        <a href='/'><h1 className="text-3xl font-bold text-indigo-600">Portfolio Generator</h1></a>
          <button onClick={() => signOut()} className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
          Sign Out
        </button>
      </nav>
      ...
      : (
        ...
        <a href='/'><h1 className="text-3xl font-bold text-indigo-600">Portfolio Generator</h1></a>
          ...
          <button  onClick={() => signIn("google")} className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
         Sign In
        </button>
        
      </nav>
        <h1 className="text-center text-gray-700">Please SignIn first to continue</h1>
        </>
      )}
    </div>
  );
  ...
  return (
    <div className="max-w-xs bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-4">
        ...
        <a target="_blank" href={previewlink} className="mt-3 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
          Preview
        </a><br></br>
        <div  className="mt-3 px-1 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
          <a target="_blank" className="px-3" href={editlink}>Edit Site</a>
        </div>
        <div  className="mt-3 px-1 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
